          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 md:flex-1 md:justify-end">
              ...
              <button
                ...
                onClick={hasStarted ? nextStep : startExam}
                disabled={loading}
                className="rounded-md bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 md:ml-auto"
              >
