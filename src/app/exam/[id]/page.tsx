        ...
        <section className="relative flex flex-col gap-3">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:flex-1 sm:justify-end">
              ...
              <label className="flex items-center gap-1 text-xs text-gray-600 sm:ml-1">
                <input
                  type="checkbox"
                  checked={ttsEnabled}
              ...
              <button
                ...
                onClick={hasStarted ? nextStep : startExam}
                disabled={loading}
                className="rounded-md bg-blue-600 px-3 py-1.5 text-sm text-white hover:bg-blue-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-400 sm:ml-auto"
              >
